...
Checkbox component for binary select| `containerClassName` | `string` | - | Additional CSS classes for container |

## Accessibility. Supports multiple visual variants, semantic colors, and provides excellent accessibility for form interactions.
